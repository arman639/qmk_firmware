...
[_BASE] = LAYOUT(
  ...
  KC_A, KC_S, KC_D, KC_F, KC_G,           KC_H, KC_J, KC_K, KC_L, KC_SCLN, RSFT_T(KC_QUOT), 
...
[_HOMERIGHT] = LAYOUT(
  ...
  KC_TRNS, KC_TRNS, KC_S, KC_D, KC_F, KC_TRNS,                     KC_TRNS, OS_CTRL, OS_SHFT, OS_ALT, KC_TRNS, KC_TRNS, 
