...
[_BASE] = LAYOUT(
  ...
  LT(_MACRO, KC_ENT), KC_Q, KC_W, KC_E, KC_R, KC_T,                           KC_Y, KC_U, KC_I, KC_O, KC_P, KC_GRV,
  LM(_MOUSE, MOD_LSFT), KC_A, KC_S, KC_D, KC_F, KC_G,           KC_H, KC_J, KC_K, KC_L, KC_SCLN, RSFT_T(KC_QUOT),
  KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_BTN2,                 KC_BTN1, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, CTL_T(KC_BTN1),
...
[_NAV] = LAYOUT(
  ...
  KC_LCTL, LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), KC_NO, KC_NO, KC_SCRL,   KC_NO, KC_PGUP, KC_PGDN, KC_ENT, RGUI(KC_T), KC_WH_D,
                              KC_TRNS, KC_TRNS, KC_NO, KC_SPC,                      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
...
[_MOUSE] = LAYOUT(
  KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,                                         KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
  KC_TRNS, KC_MRWD, KC_MFFD, KC_VOLD, KC_VOLU, KC_MUTE,                                         KC_NO, KC_NO, KC_MS_U, KC_NO, KC_NO, KC_NO,
